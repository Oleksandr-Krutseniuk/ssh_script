...
scp "$archive_name" "$receiver_user@$receiver_host:/home/******/$archive_name" # якщо потрібно - можна створити змінну для місця зберігання
...
received_file_size=\$(stat -c%s "/home/******/$archive_name")
